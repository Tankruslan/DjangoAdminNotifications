...
SECRET_KEY = 'smwa2ar93f&)*$p+v_(!0q$i))63)4a_t&ut7ilauzutj&d1(9'
...
DATABASE SETTINGS:
    default:
        localhost: user: 'postgres', password: 'ruslan', 
              name: 'admin_postgres_db', host: 'localhost'
        docker: user: 'docker-postgres', password: 'docker-postgres-psw', 
              name: 'docker-admin-postgres-db', host: 'postgres'
